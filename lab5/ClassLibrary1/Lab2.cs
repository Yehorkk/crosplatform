            ...
            try
            {
                ...
                using (StreamWriter writer = new StreamWriter(outputFile))
                {
                    ...
                    if (M <= 0)
                    {
                        ...
                        return "Ошибка: M должно быть положительным числом.";
                    }
                    ...
                    for (int i = 0; i < M; i++)
                    {
                        ...
                        if (values.Length != 2 || !int.TryParse(values[0], out int W) || !int.TryParse(values[1], out int E))
                        {
                            ...
                            return $"Ошибка в строке {i + 2}: Некорректные данные для сорта ели.";
                }
                    ...
                    if (flowerbedValues.Length != N)
                    {
                        ...
                        return "Ошибка: Количество координат клумб должно быть равно N.";
                    }
                    ...
                    for (int i = 0; i < N; i++)
                    {
                        if (!int.TryParse(flowerbedValues[i], out flowerbeds[i]))
                        {
                            ...
                            return $"Ошибка в строке {i + M + 3}: Некорректные данные для клумбы.";
                        }
                    }
